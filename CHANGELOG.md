...
* **nntp:** tag provider name in connection-lock and command-error logs ([#441](https://github.com/nzbdav-dev/nzbdav/issues/441)) ([794948b](https://github.com/nzbdav-dev/nzbdav/commit/794948be293eaade7e495cb9ea88045ae33d699b))
